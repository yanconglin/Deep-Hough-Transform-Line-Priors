...
##### A short note: The evaluation in [Learning to Parse Wireframes in Images of Man-Made Environments](https://github.com/huangkuns/wireframe) is deeply flawed, as it does not penalize over-/under-segmentation.
