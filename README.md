...
#### Important: the evaluation propsoed by [Learning to Parse Wireframes in Images of Man-Made Environments](https://github.com/huangkuns/wireframe) is deeply flawed, because it does not penalize over-/under-segmentation.
